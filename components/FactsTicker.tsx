...
const ANNOUNCEMENTS = [
  ...
  'Any player can opt out of the GF NFS Premier League at any time. Their card comes down within 48 hours — email info@grassrootsfantasy.co.nz.',
  'Cards celebrate players. Scoring reflects only what happens on the field, and no player has to be part of it.',
