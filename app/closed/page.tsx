/* Shown in place of any page in UNDER_CONSTRUCTION or CLOSED_GAMES.
   Deliberately standalone — no Nav, no Supabase, nothing that can fail while
   the database is being cleared out from under it. */
  ...
  return (
    <main className="cl-root">
      ...
      <div className="cl-box">
        <p className="cl-eyebrow">Under construction</p>
      ...
      <style>{`
        ...
        /* Darkest through the middle where the copy sits, so the artwork still
           shows at the edges without swallowing the words. */
        .cl-scrim {
