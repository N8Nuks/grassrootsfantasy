...
export default function Leagues() {
  return (
    <main className="min-h-screen w-full flex flex-col" style={{ background: '#141210' }}>
      ...
      <section className="relative px-6 overflow-hidden" style={{ paddingTop: "80px", paddingBottom: "56px" }}>
      ...
      <section className="w-full flex-1" style={{ padding: '0 20px 80px' }}>
        <div className="w-full grid gap-6 sm:gap-8 sm:grid-cols-2" style={{ maxWidth: '900px', marginLeft: 'auto', marginRight: 'auto' }}>

          {/* NFS League — live */}
          <div className="group relative rounded-[2rem] p-7 sm:p-10 flex flex-col items-center gap-5 text-center transition-all hover:scale-[1.01] sm:col-span-2"
            style={{ background: 'linear-gradient(160deg, #10214D 0%, #141210 100%)', border: '2px solid #E8C15A70', boxShadow: '0 0 40px #E8C15A20', paddingTop: "40px" }}>
          ...
          <div className="relative rounded-[2rem] p-7 sm:p-10 flex flex-col items-center gap-5 text-center sm:col-span-2"
            style={{ background: '#18151080', border: '1px dashed #F5F1E830', paddingTop: "40px" }}>
            <span className="text-[10px] font-black uppercase tracking-[0.25em] text-[#F5F1E8]/50" style={{ lineHeight: "1.6" }}>Coming Soon</span>
            <h2 className="text-2xl sm:text-3xl font-black text-[#F5F1E8]/80 leading-tight" style={{ fontFamily: 'var(--font-heading)' }}>
              Your competition here
            </h2>
            <p className="text-sm text-[#F5F1E8]/60 leading-relaxed" style={{ maxWidth: '520px' }}>
            ...
            <a href="/join" className="w-full rounded-full text-center font-black uppercase tracking-widest text-[#F5F1E8]/80 border border-[#F5F1E8]/30 hover:border-[#F5F1E8]/60 hover:text-[#F5F1E8] transition-all"
              style={{ padding: "18px 24px", fontSize: "14px", lineHeight: "1.4", maxWidth: '420px' }}>
